...
def train_conv_net(datasets,
    ...
    for name, val in candidates.items():
        for idnum,csv_num in val['ids']:
            ...
            val['means'] += ps
            if ps[0]<0.15 or ps[1] < 0.15:
                val['extremes'].append((csv_num, ps))
    while (epoch < n_epochs):
        ...
        print " Hope this works " + str(get_probs(sent))
        print name                    
